 ...
 * - Copy toàn bộ các file css,js,images... vào thư mục
 * assets của MVC
 * - Copy file html trang chủ, paste vào file layout
 * main.php này
 * - Sửa lại đường dẫn file cho chính xác theo mô hình
 * MVC hiện tại
 * - Thư mục mockup_html, copy thư mục backend/assets
 * -> paste đè vào thư mục assets của MVC hiện tại
 * - Copy mockup_html/backend/index.html -> paste vào
 * file layout main.php này
 */
?>
